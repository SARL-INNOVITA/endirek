...
/**
 * Paramètres de pagination des listes publiques : ?limit=&offset= —
 * bornés pour protéger l'API (limit ≤ 100).
 *
 * Mutualisé depuis l'étape 4 (users, admin, posts, feed, saved-posts...) —
 * anciennement dans modules/users/dto, ré-exporté là-bas pour compatibilité.
 */
