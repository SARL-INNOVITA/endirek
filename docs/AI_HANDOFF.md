...
**Dernier commit connu : `bd59d73`** — `feat: Modération avancée Dealplace (Lot 2 CP2.5)` (**local, non poussé** : validation product owner attendue).
Branche : `main`. Historique récent : `f700b8b` (**CP2.4 — Deals + avis**) → `b9e5f33` (doc CP2.4 — poussés le 2026-07-12) → `bd59d73` (**CP2.5 — Modération avancée**, local + son commit doc). CP2.1 → CP2.4 **validés par le product owner et poussés** (CP2.1-2.3 le 2026-07-11, CP2.4 le 2026-07-12).
