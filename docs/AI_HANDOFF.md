...
Branche : `main`. Historique récent : `30581dd` (**CP2.2 — Profil Dealplace**) → `1ca0a79` (doc CP2.2) → `1a8f0e6` (fix export RGPD : bloc `listings`) → `44dfb24`/`5f45a0c` (docs validation CP2.2) → `b1258e8` (**CP2.3 — Conversations**) → `3f6ab3c` (doc CP2.3). CP2.1, CP2.2 et CP2.3 **validés par le product owner et poussés le 2026-07-11**.
